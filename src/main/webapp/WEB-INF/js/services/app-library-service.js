angular.module('clever.management.services.appLibrary', []).service('appLibraryService', ['$http', 'APPLICATIONS_URL', 'TEMP_URL', 'APPLICATION_UPLOAD_URL', 'APPLICATION_BY_ID_URL',
function($http, APPLICATIONS_URL, TEMP_URL, APPLICATION_UPLOAD_URL, APPLICATION_BY_ID_URL) {

	this.getAllApplications = function() {
		return $http.get(APPLICATIONS_URL).then(function(response) {
